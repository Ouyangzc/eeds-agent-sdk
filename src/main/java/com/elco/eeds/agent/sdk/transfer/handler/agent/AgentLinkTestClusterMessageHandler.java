 ...
 * @Version 1.0
 */
public class AgentLinkTestClusterMessageHandler extends IReceiverMessageHandler {
    ...
    public void handleRecData(String topic, String recData) {
        ...
        try {
            ...
            MqPluginUtils.sendAgentLinkTestClusterMsg(rspTopic, JSONUtil.toJsonStr(rspMessage));
        }catch (Exception e) {
